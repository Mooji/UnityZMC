...
internal class BMDataAccessor
{
    ...
    public const string BundleDataPath = "Assets/--UnityPlugins--/BundleManager/BundleData.txt";
    public const string BMConfigerPath = "Assets/--UnityPlugins--/BundleManager/BMConfiger.txt";
    public const string BundleBuildStatePath = "Assets/--UnityPlugins--/BundleManager/BuildStates.txt";
    public const string UrlDataPath = "Assets/--UnityPlugins--/BundleManager/Resources/Urls.txt";
